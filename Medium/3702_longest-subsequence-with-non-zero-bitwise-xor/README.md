...
|Problem ID          |**3702**|
|Difficulty          |**Medium**|
|Leetcode Link       |[link!](https://leetcode.com/problems/longest-subsequence-with-non-zero-bitwise-xor/description/)
